...
class Elements_database():
    
    def __init__(self):
        self.database = {}
        self.selected_database = []
    
    def add_to_database(self, elements_path: str, name: str, element_object: element_output, 
                        cat: obspy.Catalog):
        self.database[name] = {'element_object': element_object, 'cat': cat, 'elements_path': elements_path}
